...
public class MQHorizontalPagingView: UIView {
    ...
    public init(frame: CGRect, info: ViewInfo) {
        ...
        self.scrollView.frame.size.width = self.viewInfo.pageWidth
    ...
    public override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        ...
        if pageWidth < self.collectionView.frame.size.width {
            contentSiz.width -= self.collectionView.frame.size.width - pageWidth
        }
...
UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let siz = CGSize(width: pgView.viewInfo.cellWidth, height: pgView.frame.size.height)
        return siz
    }
